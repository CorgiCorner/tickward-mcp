...
describe("OAuth props", () => {
  it("escapes dynamic authorization error content", () => {
    const rendered = renderAuthorizeError(`<script>alert("x")</script> & 'quote'`)

    expect(rendered).toContain("&lt;script&gt;alert(&quot;x&quot;)&lt;/script&gt; &amp; &#39;quote&#39;")
